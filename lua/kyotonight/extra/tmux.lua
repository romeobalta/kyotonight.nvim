...
set -g status-left "#[fg=${purple},bg=${bg_statusline},nobold] #S #[default] "
set -g status-right "#[default] #[fg=${blue},bg=${bg_statusline}] #{prefix_highlight} #[default] %Y-%m-%d  %I:%M %p #[fg=${black},bg=${blue},nobold] #h "
if-shell '[ "$(tmux show-option -gqv "clock-mode-style")" == "24" ]' {
  set -g status-right "#[default] #[fg=${blue},bg=${bg_statusline}] #{prefix_highlight} #[default] %Y-%m-%d  %H:%M #[fg=${black},bg=${blue},nobold] #h "
}
...
setw -g window-status-format "#[fg=${comment},bg=${bg_statusline},nobold] #I:#W #F #[default]"
setw -g window-status-current-format "#[fg=${blue},bg=${fg_gutter},nobold] #I:#W #F #[default]"
