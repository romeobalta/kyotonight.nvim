...
function M.setup()
  local kyotonight = require("kyotonight")
  ...
  -- kyotonight.setup({ plugins = { all = true } })
  for _, extra in ipairs(names) do
    local info = M.extras[extra]
    local plugin = require("kyotonight.extra." .. extra)
    for style, style_name in pairs(styles) do
      local colors, groups, opts = kyotonight.load({ style = style, plugins = { all = true } })
      local fname = extra
      ...
      colors["_upstream_url"] = "https://github.com/folke/kyotonight.nvim/raw/main/extras/" .. fname
      colors["_style_name"] = "kyoto Night" .. style_name
      colors["_name"] = "kyotonight_" .. style
      colors["_style"] = style
      print("[write] " .. fname)
