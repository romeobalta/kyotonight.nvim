...
.theme-dark {
  ...
  --text-muted: ${fg_dark};
  --text-link: ${blue};
  --text-link-low-saturation: ${teal_saturated};
  --text-positive: ${hint};
  ...
  --background-modifier-hover: ${terminal_black}26;
  --background-modifier-selected: ${terminal_black}32;
  --background-modifier-accent: ${terminal_black}42;
  --background-modifier-active: ${terminal_black}2B;
  ...
  --info-danger-text: ${fg};
  --info-help-background: ${teal_saturated}26;
  ...
  --button-danger-background-active: ${teal_saturated};
  --button-danger-background-disabled: ${red};
  --button-positive-background: ${hint};
  --button-positive-background-hover: ${green_saturated};
  --button-positive-background-active: ${teal};
  --button-positive-background-disabled: ${hint};
  --button-secondary-background: ${terminal_black};
  ...
  --button-outline-positive-background-active: ${green_saturated};
  ...
  --button-outline-brand-border-active: ${blue};
  --button-outline-primary-text: ${fg};
  --button-outline-primary-border: ${terminal_black};
  --button-outline-primary-background: transparent;
  --button-outline-primary-background-hover: ${terminal_black};
  --button-outline-primary-text-hover: ${bg};
  --button-outline-primary-border-hover: ${terminal_black};
  --button-outline-primary-background-active: ${terminal_black};
  --button-outline-primary-text-active: ${bg};
  --button-outline-primary-border-active: ${terminal_black};
  --modal-background: ${bg};
  ...
  --channel-text-area-placeholder: ${terminal_black}7F;
  ...
  --interactive-muted: ${terminal_black}4C;
...
:root {
  ...
  --color-1: ${red_saturated};
  --color-2: ${orange};
  --color-3: ${yellow};
  --color-4: ${green};
  --color-5: ${green_saturated};
  --color-6: ${blue};
  --color-7: ${blue_saturated};
  --color-8: ${cyan};
  --color-9: ${blue};
  --color-10: ${magenta};
  --color-11: ${fg};
