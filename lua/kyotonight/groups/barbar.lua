...
function M.get(c)
  ...
  return {
    ...
    BufferAlternateTarget = { bg = c.fg_gutter, fg = c.red_saturated },
    ...
    BufferCurrentTarget   = { bg = c.bg, fg = c.red_saturated },
    BufferCurrentWARN     = { bg = c.bg, fg = c.warning },
    BufferInactive        = { bg = Util.blend_bg(c.bg_highlight, 0.4), fg = Util.blend_bg(c.inactive, 0.8) },
    ...
    BufferInactiveIndex   = { bg = Util.blend_bg(c.bg_highlight, 0.4), fg = c.inactive },
    ...
    BufferInactiveTarget  = { bg = Util.blend_bg(c.bg_highlight, 0.4), fg = c.red_saturated },
    BufferInactiveWARN    = { bg = Util.blend_bg(c.bg_highlight, 0.4), fg = Util.blend_bg(c.warning, 0.8) },
    BufferOffset          = { bg = c.bg_statusline, fg = c.inactive },
    BufferTabpageFill     = { bg = Util.blend_bg(c.bg_highlight, 0.8), fg = c.inactive },
    ...
    BufferVisibleTarget   = { bg = c.bg_statusline, fg = c.red_saturated },
