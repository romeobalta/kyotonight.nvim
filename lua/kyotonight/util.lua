...
function M.invert(color)
  ...
  elseif type(color) == "string" then
    local hsluv = require("kyotonight.hsluv")
    if color ~= "NONE" then
...
---@param groups kyotonight.Highlights
...
function M.cache.file(key)
  return vim.fn.stdpath("cache") .. "/kyotonight-" .. key .. ".json"
end

---@param key string
function M.cache.read(key)
  ---@type boolean, kyotonight.Cache
